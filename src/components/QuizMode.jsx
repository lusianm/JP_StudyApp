...
export default function QuizMode({
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-6 flex flex-col items-center">
        ...
        <div className="text-center mt-10">
          ...
          <p className="text-gray-500 mb-8">{quizIds.length}개 단어를 모두 풀었습니다</p>
  ...
  // words에서 현재 id에 해당하는 단어 찾기 (항상 최신 체크 상태 반영)
  const currentId = quizIds[index]
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-sm text-gray-500">{index + 1} / {quizIds.length}</span>
      ...
      <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-1.5 mb-8">
        <div
          ...
          style={{ width: `${((index + 1) / quizIds.length) * 100}%` }}
        />
      </div>
